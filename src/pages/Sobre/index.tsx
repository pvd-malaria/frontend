          ...
          <div className="listMembros">
            ...
            <div className="membro">
              ...
              <p className="bio">Co-PI. Pesquisadora Visitante da UNESP. Bacharelado e Mestrado em Ciências Biológicas, Doutora em Ciências na área Biologia da Relação 
                Patógeno-Hospedeiro, e Pós-doc atuando malária.</p>
            </div>
            <div className="membro">
          ...
          <div className="listMembros">
            <div className="membro">
              ...
              <p className="bio">Professor e Diretor Associado da Faculdade de Ciências Aplicadas da Unicamp. 
                Formação em Ciências Humanas, Ciências Sociais Aplicadas, Economia, Antropologia, e, População e Ambiente. Pesquisador-colaborador do Núcleo de Estudos de População (NEPO-Unicamp).</p>
            </div>
            <div className="membro">
            ...
            <div className="membro">
              ...
              <p className="bio">Pesquisador Associado. Bacharel em Ciências Sociais e Mestre em Demografia pela UNICAMP.

B
                ambos pela Universidade Estadual de Campinas.</p>
            </div>
          </div>
        </div>
